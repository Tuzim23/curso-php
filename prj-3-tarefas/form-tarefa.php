...
<body>
    <div class="container mt-3">
        <?php include("gravar-tarefas.php"); ?>
        <div class="row justify-content-center">
            <div class="col-8">
                ...
                <?php } ?>
                <form action="form-tarefa.php" method="POST">
                    ...
                    <button type="submit" class="btn btn-primary">Gravar tarefa</button>
                    <a href="form-tarefa.php" class="btn btn-secondary">Novo</a>
                ...
                <table class="table">
                    ...
                    while ($linha = $resut->fetch_assoc()) {
                        ...
                        <td>$t</td>
                        <td>
                            <a href='form-tarefa.php?editar=$id'>✏</a>
                            <a href='form-tarefa.php?apagar=$id' onclick='return apagar()'>🗑</a>
                        </td>
                    </tr>";
                    }
                    ?>
